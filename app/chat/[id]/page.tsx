...
const mockChatData = {
    ...
    messages: [
        ...
        {
            id: "5",
            images: ["data:image/svg+xml,%3csvg width='200' height='200' xmlns='http://www.w3.org/2000/svg'%3e%3crect width='200' height='200' fill='%23f3f4f6'/%3e%3crect x='75' y='75' width='50' height='50' fill='%23d1d5db'/%3e%3ctext x='100' y='105' text-anchor='middle' fill='%236b7280' font-family='Arial' font-size='16'%3e📱%3c/text%3e%3c/svg%3e", "data:image/svg+xml,%3csvg width='200' height='200' xmlns='http://www.w3.org/2000/svg'%3e%3crect width='200' height='200' fill='%23f3f4f6'/%3e%3crect x='75' y='75' width='50' height='50' fill='%23d1d5db'/%3e%3ctext x='100' y='105' text-anchor='middle' fill='%236b7280' font-family='Arial' font-size='16'%3e📱%3c/text%3e%3c/svg%3e"],
                    ...
                    <CardContent className="p-4">
                        <div className="flex items-center gap-4">
                            <div className="relative w-16 h-16 rounded-lg overflow-hidden">
                                <Image
                                    src={mockChatData.listing.image || "data:image/svg+xml,%3csvg width='80' height='80' xmlns='http://www.w3.org/2000/svg'%3e%3crect width='80' height='80' fill='%23f3f4f6'/%3e%3crect x='20' y='20' width='40' height='40' fill='%23d1d5db'/%3e%3ctext x='40' y='45' text-anchor='middle' fill='%236b7280' font-family='Arial' font-size='14'%3e📦%3c/text%3e%3c/svg%3e"}
                    ...
                    {mockChatData.messages.map((message) => (
                        <div key={message.id} className={`flex ${message.fromMe ? "justify-end" : "justify-start"}`}>
                            <div className={`max-w-[70%] ${message.fromMe ? "order-2" : "order-1"}`}>
                                {message.type === "text" && (
                                    <div
                                        className={`p-3 rounded-lg ${message.fromMe ? "bg-primary text-primary-foreground" : "bg-muted text-muted-foreground border"
                                            }`}
                                    >
                                        ...
                                        <div className="grid grid-cols-2 gap-2">
                                            {message.images.map((image, index) => (
                                                <div key={index} className="relative aspect-square rounded-lg overflow-hidden">
                                                    <Image
                                                        src={image || "data:image/svg+xml,%3csvg width='200' height='200' xmlns='http://www.w3.org/2000/svg'%3e%3crect width='200' height='200' fill='%23f3f4f6'/%3e%3crect x='75' y='75' width='50' height='50' fill='%23d1d5db'/%3e%3ctext x='100' y='105' text-anchor='middle' fill='%236b7280' font-family='Arial' font-size='16'%3e📦%3c/text%3e%3c/svg%3e"}
                                ...
                                {message.type === "offer" && (
                                    <div
                                        className={`p-3 rounded-lg border-2 ${message.fromMe ? "border-primary bg-primary/10" : "border-accent bg-accent/10"
                                            }`}
                                    >
