...
const mockListing = {
    ...
    image: "data:image/svg+xml,%3csvg width='100' height='100' xmlns='http://www.w3.org/2000/svg'%3e%3crect width='100' height='100' fill='%23f3f4f6'/%3e%3crect x='25' y='25' width='50' height='50' fill='%23d1d5db'/%3e%3ctext x='50' y='55' text-anchor='middle' fill='%236b7280' font-family='Arial' font-size='16'%3e📱%3c/text%3e%3c/svg%3e",
    price: 450000,
    seller: {
        name: "Adebayo O.",
        verified: true,
                ...
                <Card className="border-0 bg-card/80 backdrop-blur-sm">
                    ...
                    <CardContent className="space-y-3">
                        {paymentMethods.map((method) => (
                            <div
                                key={method.id}
                                className={`p-4 rounded-lg border-2 cursor-pointer transition-all ${selectedMethod === method.id ? "border-primary bg-primary/5" : "border-border hover:border-primary/50"
                                    }`}
                            ...
                            >
                                <div className="flex items-center justify-between">
                                    ...
                                    <div
                                        className={`w-4 h-4 rounded-full border-2 ${selectedMethod === method.id ? "border-primary bg-primary" : "border-muted-foreground"
                                            }`}
                                    >
